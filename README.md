...
To work around this, *setup-cached-uv* allows you several ways to invalidate the cache by adding suffixes.
This way you can have multiple caches per workflow that contain different sets of packages and have it expire even if in use.
...
Meaning, without adding suffixes yourself, the names of the caches look something like `uv-Linux-CI-tests-30`, `uv-macOS-CI-tests-30`, and `uv-Windows-CI-tests-30`.
